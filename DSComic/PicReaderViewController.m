...
@interface PicReaderViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,TableViewCellDelegate>
...
@implementation PicReaderViewController
...
-(void)singleTapGesAction:(UITapGestureRecognizer*)tapGesture{
    ...
    if (point.x<xs) {
        ...
        if (!self.statusHiden){
            ...
            [self.coverView setCoverViewWithTitle:@"Test Title" CurrentPage:minPage Totle:self.dataAry.count-1];
