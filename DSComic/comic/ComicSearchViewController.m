...
@interface ComicSearchViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,HotSearchTableViewCellDelegate,UIGestureRecognizerDelegate>
