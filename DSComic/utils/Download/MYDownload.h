...
typedef void(^DProgressBlock)(CGFloat progress, long long downloadedlength, long long totalLength);
...
@property (nonatomic, copy) DProgressBlock progressBlock;    // 下载进度回调
