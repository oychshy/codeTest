...
- (void)addTimer{
    ...
    mv_timer = [NSTimer scheduledTimerWithTimeInterval:4.0 target:self selector:@selector(timerFUNC:) userInfo:nil repeats:YES];
...
- (UIPageControl *)mainPage{
    ...
    if (!_mainPage) {
        ...
        //初始化分页控制器
        _mainPage = [[UIPageControl alloc]initWithFrame:CGRectMake( mv_width-100, mv_height - 20,  100, 20)];
        ...
        //设置 滑动点(当前点) 的颜色
        _mainPage.currentPageIndicatorTintColor = [UIColor orangeColor ];
    }
